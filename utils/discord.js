...
export async function permissionsIn(channel, forceFetch = false)
{
	let guild;
	try {
		guild = await client.guilds.fetch(channel.guildId)
...
if(!CommandInteraction.prototype.fetchGuild)
{
	Object.defineProperty(CommandInteraction.prototype, "fetchGuild", {
		value: function() { return client.guilds.fetch(this.guildId); },
	});
}
